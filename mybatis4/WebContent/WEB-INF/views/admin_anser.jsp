...
<div class="col-md-12">
   <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper" >
         <h2>답변 입력</h2>
         <hr />
         <form action="/mybatis4/admin_insert" method="get">
       <c:forEach items="${result}" var="list">
         <div class="col-md-12" >
            <div class="col-md-2" >
              <!--  <input type="text" style="width:245px; height: 100%;" class="form-control text-center" value="내용" readonly="readonly" /></div> -->
            <div class="col-md-10" >
              <%--  <input type="text"  class="form-control" style="width:850px; height: 200px;" readonly="readonly" value="${list.ques_cont }" /> --%>
               <table class="table table-bordered" style="width:1100px;">
               	<tr>
               		<th>문의 상세내역</th>
               	</tr>
               	<tr>
               		<td >${list.ques_cont }</td>
               	</tr>
               </table>
            </div>
         </div>
         ...
         <div class="col-md-12 ">
            <div class="col-md-2 text-right">
               <input type="text" style="width:245px; height: 210px;" class="form-control text-center" value="답변작성" readonly="readonly"  /></div>
            <div class="col-md-10 text-left">
               <input type="text" name="anser"  class="form-control" style="width:850px; height: 210px;" />
            </div>
         </div>
         <div class="col-md-12" style="margin-top: 20px;">
            ...
            <div class="col-md-4">
               <button type="button" style="width: 100px;" class="btn btn-info" onclick="location.href='/mybatis4/admin_queslist'">취소</button>
            </div>
         </div>
      </form>
        </div>
